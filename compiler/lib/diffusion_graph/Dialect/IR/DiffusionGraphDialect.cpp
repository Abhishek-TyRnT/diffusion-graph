...
#include "diffusion_graph/Dialect/IR/DiffusionGraphIRDialect.cpp.inc"

#define GET_TYPEDEF_CLASSES
#include "diffusion_graph/Dialect/IR/DiffusionGraphTypes.cpp.inc"
...
//===----------------------------------------------------------------------===//
// diffusionGraphIR dialect parseType/printType methods.
//===----------------------------------------------------------------------===//
...
void DiffusionGraphIRDialect::initialize() {
    addOperations<
#define GET_OP_LIST
#include "diffusion_graph/Dialect/IR/DiffusionGraphOps.cpp.inc"
        >();
    addTypes<
