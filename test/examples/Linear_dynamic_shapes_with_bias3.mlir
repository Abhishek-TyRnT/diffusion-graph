module attributes {torch.debug_module_name = "Linear"} {
  func.func @forward(%arg0: !torch.vtensor<[1,8,?],f32>) -> !torch.vtensor<[1,8,10],f32> {
    ...
    %3 = torch.aten.matmul %arg0, %2 : !torch.vtensor<[1,8,?],f32>, !torch.vtensor<[3,10],f32> -> !torch.vtensor<[1,8,10],f32>
    %4 = torch.aten.add.Tensor %3, %0, %int1 : !torch.vtensor<[1,8,10],f32>, !torch.vtensor<[10],f32>, !torch.int -> !torch.vtensor<[1,8,10],f32>
    return %4 : !torch.vtensor<[1,8,10],f32>
  }
}
